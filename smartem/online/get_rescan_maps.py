...
class GetRescanMapTest(GetRescanMap):
    ...
    def get_rescan_map(self, fast_em):
        if self.params["type"] == "half":
            ...
            additional = {"fast_mb": np.zeros_like(mask, dtype=np.uint8)}
            return mask, additional
