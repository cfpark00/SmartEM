...
parser.add_argument('--base_dwt',type=int,default=50, help='dwell time images to be used')
parser.add_argument('--slowest_dwt',type=int,default=1200, help='slowest dwell time images to be used')
parser.add_argument('--make_EM2Err',type=bool,default=False, help='Make dataset where x=<EM image> and y=<membrane prediction discrepancy from slowest dwell time image>')
