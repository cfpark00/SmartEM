...
parser.add_argument('-save_every', type=int,default=10000, help='save every # gradient steps')
...
parser.add_argument('-arch_skipcat',action="store_true", help='concat skip connections')
